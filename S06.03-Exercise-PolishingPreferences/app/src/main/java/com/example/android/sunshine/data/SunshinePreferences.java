...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String locationPrefKey = context.getString(R.string.pref_location_key);
        String locationPrefDefaultValue = context.getString(R.string.pref_location_default);
        /** This will be implemented in a future lesson **/
        return sharedPreferences.getString(locationPrefKey, locationPrefDefaultValue);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String defaultPreferenceValue = context.getString(R.string.pref_units_metric);
        String preference = sharedPreferences.getString(preferenceKey, defaultPreferenceValue);
        /** This will be implemented in a future lesson **/
        return preference.equals(defaultPreferenceValue);
    }
