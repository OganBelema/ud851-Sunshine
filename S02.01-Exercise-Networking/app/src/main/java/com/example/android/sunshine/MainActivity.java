...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        new WeatherAsyncCall().execute(queryUrl);
    }
    ...
    class WeatherAsyncCall extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                jsonResponse = NetworkUtils.getResponseFromHttpUrl(queryUri);
